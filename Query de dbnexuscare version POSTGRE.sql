...
CREATE TABLE Usuarios (
    -- Clave Primaria y de Identidad (Adaptado a SERIAL para PostgreSQL)
    us_clave SERIAL PRIMARY KEY,
...
CREATE TABLE Consultas (
    ...
    -- Campo para el tipo de consulta (Adaptado a CHECK para PostgreSQL)
    co_tipo_consulta VARCHAR(15) NOT NULL DEFAULT 'Virtual'
        CHECK (co_tipo_consulta IN ('Virtual', 'Presencial')),
    
    -- Claves Foráneas (referencian a Usuarios)
    paciente_clave INT NOT NULL,
    doctor_clave INT NOT NULL,
